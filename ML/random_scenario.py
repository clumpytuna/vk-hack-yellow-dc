...
class RandomScenario(BaseScenario):
    ...
    def answer(self, state, models):
        ...
        if 'xvf' in text.lower():
            return {'text':'Для незрячих и слабовидящих посетителей в рамках наиболее значимых выставок в музее предлагаются тактильные макеты экспонатов, образовательные программы, а также тематические мастер-классы по постоянной экспозиции. Тактильные макеты сопровождаются этикетками, выполненными шрифтом Брайля. \n Инклюзивная программа к выставке "Щукин. Биография коллекции" организована в рамках проекта «Доступный музей» и включает в себя тактильные макеты по мотивам произведений «Танец» Анри Матисса, «Белые кувшинки» Клода Моне, «Голубые танцовщицы» Эдгара Дега, «Домик в саду (Домик и деревья)» Пабло Пикассо, «Пьеро и Арлекин» Поля Сезанна. Макеты сопровождаются этикетками на шрифте Брайля, а также аудиогидом с тифлокомментированием.'}
